!(function (e, n) {
  ...
  var i = function (e) {
      ...
      d.classList.add("modal", "fade"),
        (d.style.backgroundColor = "#0000008f"),
        (d.isShow = !1);
      ...
      for (var x = [], E = 0; E < l.length; E++) {
        ...
        (T.type = "checkbox"),
          (T.checked = l[E].checked),
          T.classList.add("flipswitch", "wskfgakjiopfhu"),
          (T.style.fontSize = a),
          L.appendChild(T);
        var j = document.createElement("td");
        j.classList.add("woiejfwiojf"),
          (j.innerText = l[E].points),
          (j.points = l[E].points),
          T.checked && (k.innerText = +k.innerText + l[E].points);
        var q = document.createElement("td");
        q.classList.add("woiejfwiojf"),
          (q.innerText = l[E].name),
          (q.name = l[E].name),
          C.appendChild(L),
          C.appendChild(j),
          C.appendChild(q),
          x.push({ checkbox: T, points: j, name: q });
        var S,
          A = o(x);
        try {
          for (A.s(); !(S = A.n()).done; ) {
      ...
      B.classList.add("modal-footer", "_tpqqqwepiqopwef"),
  ...
  return (function () {
    function t() {
      var n =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "測試";
      e(this, t),
        (this.items = null),
        (this.dBtn = null),
        (this.modal = null),
      ...
      (l = [
        {
          ...
          value: function (e, n) {
            ...
            null === this.childArr && (this.childArr = []),
              this.childArr.push({ name: e, points: n, checked: t });
          },
        },
        {
          key: "renderModal",
          value: function (e) {
            ...
            if (null !== this.childArr)
              if (e instanceof HTMLElement) {
                ...
                console.error("Target Element is not a valid html element");
        ...
        },
        {
          ...
          value: function (e) {
            ...
            (n.href =
              ...
              "function" == typeof e && n.addEventListener("load", e);
          },
        },
        {
          ...
          value: function () {
            if (null !== this.modal) {
              ...
              this.dBtn.addEventListener("click", function (t) {
                    ...
                    try {
                      for (r.s(); !(n = r.n()).done; ) {
                        var l = n.value,
                          ...
                          s = l.points,
                          c = l.name;
                        t.push("".concat(c.name, "/").concat(s.points)),
                          i.push(+d.checked),
                          d.checked && (a += s.points);
                      }
                    } catch (e) {
                      r.e(e);
                    } finally {
                ...
                (a.download = n + " (總分: ".concat(i.total, ").csv")),
                  (a.href = URL.createObjectURL(
                    new Blob([i.csvTxt], { type: "text/plain" })
                  )),
                  a.click();
              });
